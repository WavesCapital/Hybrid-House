...
const DEFAULT_POSITIONS = {
  ...
  prRunsHorizontal: { x: 20, y: 400, width: 350, height: 80 }, // Horizontal layout - much wider for marathon
...
const OPTIMAL_SIZES = {
  ...
  prRunsHorizontal: { width: 400, height: 100 },
              ...
              <div className="h-full p-4 space-y-6 overflow-y-auto">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-3">
                    ...
                    />
                    <ComponentPreviewTile
                      type="prRunsHorizontal"
                      title="Running PRs 2"
                      prsData={prsData}
                      onAdd={() => addComponent('prRunsHorizontal')}
                      preview={<PRRunsHorizontalPreview prsData={prsData} />}
                    />
                  </div>
                </div>
...
const ComponentContent = ({ component, prsData, isSelected }) => {
  ...
  switch (type) {
    ...
    case 'prRunsHorizontal':
      return <PRRunsHorizontal {...componentProps} />;
    case 'balanceChips':
