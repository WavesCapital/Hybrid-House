                ...
                <>
                  ...
                  <button
                    ...
                    className={`nav-button px-3 py-2 text-sm border rounded-lg transition-colors flex items-center gap-2 ${
                      isCurrentPage('/') ? 'active' : 'border-gray-600 text-gray-300 hover:border-[#08F0FF] hover:text-[#08F0FF]'
                    }`}
                  >
                  ...
                  <>
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 rounded-lg transition-colors flex items-center gap-3 ${
                        isCurrentPage('/') ? 'bg-[#08F0FF]/10 text-[#08F0FF]' : 'text-gray-300 hover:bg-white/10 hover:text-[#08F0FF]'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 rounded-lg transition-colors flex items-center gap-3 ${
                        isCurrentPage('/leaderboard') ? 'bg-[#08F0FF]/10 text-[#08F0FF]' : 'text-gray-300 hover:bg-white/10 hover:text-[#08F0FF]'
                      }`}
                    >
